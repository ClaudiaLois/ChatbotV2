...
class RunCodes:
    ...
    def runNext(self):
        ...
        with open('trainWithAction.json', encoding="utf8") as json_file:
    ...
    def display(self,message):
        ...
        if self.present_context != 'bye':
            ...
            if(self.context==1 and self.cont==1):
               ...
               # yield(self.action)
               #self.conv=1
               for self.j,fields,self.cont in getattr(Info, self.action.replace(" ", ""))(self.id_,self.data,self.details,self.fields):
